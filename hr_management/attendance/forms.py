...
from employees.models import Position, Employee, Department
...
class EmployeeForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'phone', 'email', 'position', 'join_date', 'is_active', 'photo',
            'address', 'education_level', 'degree', 'major', 'basic_salary'
        ]
        widgets = {
