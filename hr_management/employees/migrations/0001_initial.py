    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.CharField(choices=[('active', 'Đang làm việc'), ('inactive', 'Đã nghỉ việc')], default='active', max_length=10, verbose_name='Trạng thái làm việc')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='employees/', verbose_name='Ảnh')),
                ('employment_type', models.CharField(blank=True, choices=[('full_time', 'Toàn thời gian'), ('part_time', 'Bán thời gian'), ('intern', 'Thực tập'), ('contract', 'Hợp đồng')], max_length=20, null=True, verbose_name='Loại công việc')),
                ('basic_salary', models.DecimalField(blank=True, decimal_places=0, default=0, max_digits=12, null=True, verbose_name='Lương cơ bản')),
                ('salary_rate', models.DecimalField(blank=True, decimal_places=2, default=100, max_digits=5, null=True, verbose_name='Tỉ lệ hưởng lương')),
                ...
                ('labor_status', models.CharField(choices=[('working', 'Đang làm việc'), ('resigned', 'Đã nghỉ việc'), ('maternity_leave', 'Nghỉ thai sản'), ('on_leave', 'Đang nghỉ phép')], default='working', max_length=20, verbose_name='Tình trạng lao động')),
                ('personal_tax', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=5, null=True, verbose_name='Thuế TNCN (%)')),
                ('deduction', models.DecimalField(blank=True, decimal_places=0, default=0, max_digits=12, null=True, verbose_name='Khấu trừ')),
                ('performance_bonus', models.DecimalField(blank=True, decimal_places=0, default=0, max_digits=12, null=True, verbose_name='Thưởng hiệu suất')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50, verbose_name='Tên vị trí công vi���c')),
        ...
        migrations.AddField(
            model_name='employee',
            name='position',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='employees.position', verbose_name='Vị trí công việc'),
        ),
    ]
